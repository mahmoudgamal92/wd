										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="mb-3">
													...
													<select dir="rtl" name="state_id" class="default-select form-control wide mb-3">
											...
											<div class="col-md-12">
												<div class="mb-3">
													<input type="text" class="form-control input-default" name="name" placeholder="أدخل أسم  المدينة" required>
												</div>
											</div>

											<div class="col-md-12">
												<div class="mb-3">
													<input type="text" class="form-control input-rounded" name="coords" placeholder=" أدخل الإحداثيات">
												</div>
											</div>
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td>
													<div class="d-flex">
														<a href="api/address/city.php?action=delete&id=<?= $row['city_id'] ?>" class="btn btn-danger shadow btn-xs sharp me-1">
