...
if (mysqli_num_rows($res) > 0) {
    ...
    $cmd = "insert into users (user_name, user_phone, user_email, user_type, user_token,notification_token,last_otp) values 
    ('$user_name', '$user_phone', '$user_email','$user_type', '$user_token','$notification_token','$otp_code')";
    $res = mysqli_query($con, $cmd);
