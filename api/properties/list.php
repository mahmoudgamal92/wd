...
if($prop_type == "1")
{
$cmd = "select * from props where prop_state = '$region_id' order by prop_id desc";
}

else
{
    $cmd = "select * from props where prop_type = '$prop_type' and prop_state = '$region_id' order by prop_id desc";
}
...
$cmd = "select * from props order by prop_id desc";
$res = mysqli_query($con, $cmd);
if(mysqli_num_rows($res) > 0)
{
    $json_Array = array();
