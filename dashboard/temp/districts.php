								...
								<div class="basic-form">
									<form method="POST" action="api/address/district.php">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="mb-3">
													<select dir="rtl" name="city_id" class="default-select form-control wide mb-3">
														<?php
											...
											<div class="col-md-12">
												<div class="mb-3">
													<input type="text" class="form-control input-default" name="name" placeholder="أدخل أسم الحي" required>
												</div>
											</div>
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td>
													<div class="d-flex">
														<a href="api/address/district.php?action=delete&id=<?= $row['id'] ?>" class="btn btn-danger shadow btn-xs sharp me-1">
